...
export class TicketService {
    ...
    private readonly workingOnTickets: Ticket[] = this.tickets;
    ...
    private onTicketNumberChanged( ) {
        const count = this.getPendingTickets();
        console.log(`Tickets pendientes: ${count}`);
        this.wssService.sendMessage('on-ticket-count-changed', count.length);
    }
